...
{{--<div class="panel-group sidebar-accordion" id="accordion">--}}
	...
	{{--<!-- PREMIER PANNEL ACCORDION SANS CONTENU -->--}}
    {{--<div class="panel panel-default">--}}
		{{--<!-- Header -->--}}
        {{--<div class="panel-heading">--}}
            {{--<h4 class="panel-title"><a data-parent="#accordion" href=--}}
            {{--"http://127.0.0.1/elipce_workflow/utilisateur"><span class=--}}
            {{--"glyphicon glyphicon-user"></span>Utilisateurs</a></h4>--}}
        {{--</div>--}}
    {{--</div>--}}

	{{--<!-- PREMIER PANNEL ACCORDION AVEC CONTENU -->--}}
    {{--<div class="panel panel-default">--}}
		{{--<!-- Header -->--}}
        {{--<div class="panel-heading">--}}
            {{--<h4 class="panel-title"><a href=--}}
            {{--"http://127.0.0.1/elipce_workflow/profils"><span class=--}}
            {{--"glyphicon glyphicon-th"></span>Profils</a> <a data-parent="#accordion" data-toggle="collapse" href="#collapseTwo">--}}
            ...
            {{--<div class="panel-body">--}}
                {{--<table class="table">--}}
                    ...
                    {{--<tr>--}}
                        {{--<td>--}}
                            {{--<a href=--}}
                            {{--"http://www.jquery2dotnet.com">Shipments</a>--}}
                        {{--</td>--}}
                    {{--</tr>--}}
